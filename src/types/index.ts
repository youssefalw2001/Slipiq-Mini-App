...
export interface ScoreOutcome { score: string; modelProbability: number; fairOdds: number; bookmakerOdds: number | null; impliedProbability: number | null; edge: number; expectedValue: number; classLabel: string; oddsSource: 'market' | 'synthetic' }
